...
final class EditProfilePresenter: EditProfilePresenterProtocol {
    ...
    func isSaveEnabled(_ form: EditProfileFormState) -> Bool {
        ...
        let isProfileChangeValid = form.hasProfileChanges
            && Validation.validFullName(trimmedName).isValid
            && Validation.validPhone(trimmedPhone).isValid

        let isPasswordChangeValid = !form.oldPassword.isEmpty
            && !form.newPassword.isEmpty
            && !form.confirmPassword.isEmpty
            && Validation.validPassword(form.newPassword).isValid
