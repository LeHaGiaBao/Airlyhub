...
final class RegisterViewController: BaseViewController {
    ...
    private func setupUI() {
        ...
        activityIndicator.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(submitButton.titleLabel?.snp.leading ?? submitButton.snp.leading).offset(-8)
        }
    ...
    private func setupEvents() {
        ...
        bindSubmitAndLoginActions()
    }

    private func bindFormValidState() {
    ...
    private func bindFieldValidation() {
    ...
    private func bindPasswordVisibilityToggle() {
    ...
    private func bindReturnKeyChaining() {
    ...
    private func bindSubmitAndLoginActions() {
        submitButton.rx.tap
            .subscribe(onNext: { [weak self] in
                self?.submitRegister()
            })
