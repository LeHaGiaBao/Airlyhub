...
final class HelpfulInfoDetailSheetViewController: BaseBottomSheetViewController {
    private enum Layout {
        ...
        /// The scrollable part never grows past this share of the screen.
...
private extension HelpfulInfoDetailSheetViewController {
    func setupUI() {
        ...
        contentStack.snp.makeConstraints { make in
            ...
            // Keeps short articles from stretching the sheet to the cap above.
    ...
    /// A bullet dot aligned with the first line of text.
