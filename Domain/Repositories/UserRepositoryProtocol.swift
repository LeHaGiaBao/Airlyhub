...
///
/// Auth (`AuthRepositoryProtocol`) owns the credential and the uid; this owns the
/// editable profile that hangs off it — name, phone, avatar. Interactors take
/// this protocol so the Firestore read/write stays in `Data`.
